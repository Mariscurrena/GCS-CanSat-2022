...
public class FlightMode extends Scene {
	
	static MqttAsyncClient cliente; 
	static String topic = "teams/1017";
	int width = (int) Screen.getPrimary().getBounds().getWidth();
	static SerialPort Puerto;
	GridPane grid, commands, master_button, ports, cont_values, payl_values, g_bars, actions, g_barstatus,g_barmission, g_missionstatus, g_graphs, g_divgraphs, g_ppgraphs, g_ccgraphs, g_cgraphs, g_pgraphs, g_ts;
	GridPane imageprueb, g_img, g_indicators, g_contcirc, g_paycirc;
    ...
    static Text pressure = new Text("0.00 MPa");
    static Text voltage = new Text("0.0 V");
    static Text latitude = new Text("0.00");
    static Text longitude = new Text("0.00");
    static Text SATS_C = new Text("0.00");
    ...
    static String flymode = "CMD,1017,FLY,ACTIVATE";
	...
	static String sim_enable = "CMD,1017,SIM,ENABLE";
    String mode;
    ...
    //Cicle Indicators
    Label lbc1,lbc2,lbc3,lbc4,lbc5,lbc6,lbc7,lbc8,lbc9,lbc12;
    Arc cir1,cir2,cir3,cir6,cir7,cir8,cir10,cir11;
    Arc arc1,arc2,arc3,arc6,arc7,arc8,arc10,arc11;
    float cirvalue=0;
    //Clock
    ...
    public FlightMode(Pane root, int x, int y){
        super(root, x, y);
        //Grid call
        grid = new GridPane();
        ...
        g_ppgraphs = new GridPane();
        g_ccgraphs = new GridPane();
        ...
        div.div_grid(g_ppgraphs, 3, 5, x/3, 11*y/18);
        div.div_grid(g_ccgraphs, 3, 5, x/3, 11*y/18);
        ...
        Text sats = new Text("SATS are: ");
        Text c_temp = new Text("Temperature is: ");
        //Payload text field
        Text pressp = new Text("Pressure is: ");
        Text p_temp = new Text("Temperature is: ");
        Text rotp = new Text("Gyroscope are: ");
        Text accel_p = new Text("Acceleration are: ");
        Text mag_p = new Text("Magnetometer are: ");
        //Main Label
        Label com = new Label("ENTRY COMMAND");
		DropShadow shadow = new DropShadow();
		DropShadow shadowp = new DropShadow(); shadowp.setColor(Color.PURPLE);
		DropShadow shadowr = new DropShadow(); shadowr.setColor(Color.RED);
        
        //Buttons
        //**************Main button*************//
        btn = new Button("Send");
        buttons.b_normal(btn, Color.rgb(112, 48, 160), Color.rgb(218, 194, 236, 0.75), "../CSSsheets/mbtn_flight.css", 20, x, y);
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            	...
            	if(mode.equals(loads)) {
            		...
            		System.exit(0);
            		Puerto.closePort();
            	}else if(mode.equals(flymode)) {
                    ports.add(b5, 1, 1);
            		System.out.println("Flight mode activate-> Successful");
            		comm_insert.setText("");
        ...
        buttons.btogg_normal(btn_comm, Color.rgb(112, 48, 160), Color.rgb(218, 194, 236, 0.75), "../CSSsheets/mbtn_flight.css", 20, x, y);
        ...
        buttons.b_normal(refresh, Color.rgb(31, 95, 160), Color.rgb(200, 200, 255, 0.75), "../CSSsheets/refreshflight.css", 20, x, y);   
        ...
        buttons.b_action(calibration, Color.rgb(31, 95, 160), Color.rgb(200, 200, 255, 0.75), "../CSSsheets/actionsflight.css", 20, x, y);   
      ...
      //*************Buzzer Button**************//
        ...
        buttons.b_action(buzzer, Color.rgb(31, 95, 160), Color.rgb(200, 200, 255, 0.75), "../CSSsheets/actionsflight.css", 20, x, y);   
        ...
        //Label Entry Command
        labels.fade_shadow(Color.rgb(31, 95, 160), com, 50);
        blabel1.setCenter(com);
        commands.add(blabel1, 0, 0);
        
        //Combobox
        //*********Commands*********//
        buttons.combobox(combo,Color.rgb(112, 48, 160),30, x);
        ...
        //***********Ports***********//
        comboport(cbx,Color.rgb(112, 48, 160),30, x);
        ...
        //TextField
        labels.textbox(comm_insert, x, y, Color.rgb(31, 95, 160,0.5));
		...
		//////////////Image Prueb//////////////////
			...
			try {
				img.createImage("Images/modelgif.gif", image, 2*x/4.5, /*2*x/10.74615*/ 2*x/12, Color.PURPLE);
				//img.start(image);
...
///////////////CHARTS GRAPHICS////////////////////////
	   ///////////////Container Charts////////////////////////
	        ...
	        final AreaChart<Number,Number> lineChart1 = new AreaChart<Number,Number>(xAxis1,yAxis1);	                                                                                                                     //Author: @Angel Mariscurrena
	        chart.graphs(xAxis1,yAxis1,lineChart1, "Pressure", "Time (s)", "Pa", series1, (2*x/9)-20,(11*y/60)-40);
	        series1.getData().size();
	        //****************Two*******************//                                                                                                                     Author: @Angel Mariscurrena
	        ...
	        Stop[] stop1 = {new Stop(0.4, Color.rgb(195,130,255,0.95)),new Stop(1, Color.DEEPSKYBLUE)};
			...
			lbc1 = new Label("0.0 MPa"); lbc1.setStyle("-fx-font-size: 150%;");
			HBox hbcc1 = new HBox();
	    ...
	    /////////////Payload Charts////////////////////////
	        ...
	        lineChart8.getStylesheets().add(getClass().getResource("../CSSsheets/Fly_chart2.css").toExternalForm());
	        //****************Four*******************//
	        ...
	        lineChart10.getStylesheets().add(getClass().getResource("../CSSsheets/Fly_chart2.css").toExternalForm());
	      ...
	      //**************Graph end
			...
			lbc6 = new Label("0.0 MPa"); lbc6.setStyle("-fx-font-size: 150%;");
			HBox hbcc6 = new HBox();
	    ...
	    ///////////Radar///////////////////////////
			radar.design(x/12, 4*y/27, b34, Color.DEEPSKYBLUE, Color.rgb(255, 0, 80));
			rval = new Label();
		...
		//////////Indicators///////////////////////////
			...
			Stop[] stop = {new Stop(0.4, Color.rgb(255,255,255,0.95)),new Stop(0.8, Color.rgb(95, 170, 255, 0.95))};
        ...
        g_ccgraphs.add(g_paycirc,0,0,1,5);
        g_ppgraphs.add(g_contcirc,0,0,1,5);
        g_ppgraphs.add(g_cgraphs,1,0,2,5);
        g_ccgraphs.add(g_pgraphs,1,0,2,5);
...
///////////////////////////TOGGLE SWITCH CLASS/////////////////////////////////////
	public class ToggleSwitch extends HBox {
		...
		private void init() {
	        ...
	        g_divgraphs.add(g_ppgraphs,0,1,1,11);
		...
		public ToggleSwitch() {
			...
			switchedOn.addListener((a,b,c) -> {
				if (c) {
	        		...
	        		g_divgraphs.getChildren().remove(g_ppgraphs);
	                g_divgraphs.add(g_ccgraphs,0,1,1,11);
	        		setStyle("-fx-background-color: rgba(112, 48, 160, 0.475);");
	        		label.toFront();
	            }else {
	            	laser.play();
	    			label.setText("CONTAINER");
	    			g_divgraphs.getChildren().remove(g_ccgraphs);
	    	        g_divgraphs.add(g_ppgraphs,0,1,1,11);
